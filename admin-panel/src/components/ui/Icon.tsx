...
const ICONS: Record<string, string> = {
  ...
  lock:      'M6 11V9a6 6 0 0 1 12 0v2M5 11h14a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2Z',
  ...
  zoomOut:   'M11 4a7 7 0 1 1 0 14A7 7 0 0 1 11 4Zm10 17-4.35-4.35M8 11h6',
}
