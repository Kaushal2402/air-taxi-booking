...
async def get_dispatch_queue(
    ...
    _: AdminUser = Depends(require_permission("dispatch.console.view")),
...
async def assign_driver(
    ...
    request: Request,
    current_user: AdminUser = Depends(require_permission("dispatch.manual_assign")),
    db: AsyncSession = Depends(get_db),
):
...
async def resolve_exception(
    ...
    request: Request,
    current_user: AdminUser = Depends(require_permission("dispatch.exception.resolve")),
    db: AsyncSession = Depends(get_db),
):
...
async def create_surge_override(
    ...
    request: Request,
    admin_user: AdminUser = Depends(require_permission("dispatch.surge.override")),
    db: AsyncSession = Depends(get_db),
):
