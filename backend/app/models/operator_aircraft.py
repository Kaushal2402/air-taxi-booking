...
class OperatorAircraft(Base):
    ...
    aircraft_type_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    ...
    endurance_hours: Mapped[str | None] = mapped_column(String(20), nullable=True)
    home_base_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    home_base_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
...
class AircraftDocument(Base):
    ...
    doc_number: Mapped[str | None] = mapped_column(String(80), nullable=True)
